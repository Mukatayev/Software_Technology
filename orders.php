...
<script type="text/javascript">
 ...
 function initAutocomplete(){
    ...
    var autoComplete = new google.maps.places.Autocomplete(document.getElementById("clientAddress"));
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			 ...
			 <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Client Address</label>
			    <div class="col-sm-10">
			      <input type="text"  id="clientAddress" class="form-control" name="clientAddress" placeholder="Client Address" autocomplete="off" onkeyup="initAutocomplete()"/>
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Delivery Status</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType">
				      	<option value="">~~SELECT~~</option>
				      	<option value="1">Delivered</option>
				      	<option value="2">In Transit</option>
				      	<option value="3">Failed Attempt</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
				  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status, orders.client_address FROM orders 	
			 ...
			 <div class="form-group">
			    <label for="clientName" class="form-control" class="col-sm-2 control-label">Client Address</label>
			    <div class="col-sm-10">
			      <input type="text"  id="clientAddress" name="clientAddress" placeholder="Client Address" autocomplete="off" value="<?php echo $data[13] ?>" onkeyup="initAutocomplete()"/>
			    </div>
			  </div> <!--/form-group-->
